...
echo $dname:$dname"ucokbawagolok" | chpasswd
echo $dname > pass.txt
echo $dname"ucokbawagolok" >> pass.txt
...
# info
echo "Menu nya Cok"  | tee -a log-install.txt
...
echo "Password : $dname@ucokbawagolok"  | tee -a log-install.txt
